...
template <typename GuardedType, traits::basic_lockable MutexType = std::mutex>
class synchronized;
...
template <typename GuardedData, traits::basic_lockable MutexType>
class synchronized {
